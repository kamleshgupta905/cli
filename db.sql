...
/* Table structure for the junction table `vendor_projects` */
DROP TABLE IF EXISTS `vendor_projects`;
CREATE TABLE `vendor_projects` (
  `vendor_id` int(10) NOT NULL,
  `project_id` int(10) NOT NULL,
  PRIMARY KEY (`vendor_id`, `project_id`),
  KEY `vendor_projects_vendor_id_foreign` (`vendor_id`),
  KEY `vendor_projects_project_id_foreign` (`project_id`),
  CONSTRAINT `vendor_projects_vendor_id_foreign` FOREIGN KEY (`vendor_id`) REFERENCES `vendor` (`id`),
  CONSTRAINT `vendor_projects_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
